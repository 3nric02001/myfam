...
- **Essensplan:** Sonntags um 18 Uhr bekommt die Familie eine Nachricht, wenn für die nächste Woche noch Mahlzeiten offen sind. Es zählen nur die Mahlzeiten, die die Familie in den letzten vier Wochen überhaupt geplant hat (wer nie Frühstück plant, wird dazu nicht gefragt). Eine Familie ohne Essensplan bekommt nichts.
...
- **Pro Person abschaltbar:** Unter **Einstellungen → Benachrichtigungen** lässt sich jede Art (Tagesübersicht, Termine, Aufgaben, offene Aufgaben am Abend, Kommentare, Essensplan, Kassenzettel) einzeln ausschalten. Das gilt für alle Geräte der Person.
