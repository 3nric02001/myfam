...
| Erinnerungen per Push             | fertig für Termine, Aufgaben, Kommentare, Essen, Bons      |
...
- **Tagesübersicht:** Jeden Morgen um 7 Uhr bekommt jede Person eine Nachricht mit den heutigen Terminen, die sie sehen darf (auch aus Kalender-Abos), ihren offenen Aufgaben (heute fällig oder überfällig) und dem geplanten Essen. An einem leeren Tag kommt nichts.
- **Offene Aufgaben am Abend:** Um 20 Uhr bekommt jede Person eine Nachricht, wenn von ihren Aufgaben für heute (oder überfälligen) noch etwas offen ist. „Ihre“ heißt: ihr zugewiesen oder von ihr ohne Zuständige angelegt.
- **Wochenplanung:** Sonntags um 15 Uhr lädt eine Nachricht die ganze Familie zur Wochenplanung ein (siehe unten). Hat schon jemand die Woche abgeschlossen, entfällt sie.
- **Essensplan:** Sonntags um 18 Uhr bekommt die Familie eine Nachricht, wenn für die nächste Woche noch Mahlzeiten offen sind und niemand die Wochenplanung abgeschlossen hat. Es zählen nur die Mahlzeiten, die die Familie in den letzten vier Wochen an diesem Wochentag geplant hat, oder an mindestens drei verschiedenen Wochentagen (wer nur sonntags mittags kocht, wird unter der Woche nicht nach Mittag gefragt). Eine Familie ohne Essensplan bekommt nichts. Die Nachricht führt direkt zum Essens-Schritt der Wochenplanung.
- **Kassenzettel:** Wer beim Einkauf etwas abhakt und dann 5 Minuten lang nichts mehr abhakt, bekommt eine Erinnerung, den Bon zu fotografieren. Sie kommt einmal pro Einkauf, nur an diese Person und nicht, wenn inzwischen jemand aus der Familie einen Kassenzettel gespeichert hat. Wer etwas versehentlich abhakt und gleich wieder zurücknimmt, bekommt nichts. Nach 3 Stunden ohne Abhaken beginnt ein neuer Einkauf.
- **Pro Person abschaltbar:** Unter **Einstellungen → Benachrichtigungen** lässt sich jede Art (Tagesübersicht, Termine, Aufgaben, offene Aufgaben am Abend, Kommentare, Wochenplanung, Essensplan, Kassenzettel) einzeln ausschalten. Das gilt für alle Geräte der Person.
...
- **Essen** fragt Mahlzeit für Mahlzeit („Was gibt es am Freitag zum Abendessen?“) und schlägt Gerichte aus dem Essensplan des letzten Jahres vor: zuerst was es an diesem Wochentag oft gibt („Oft am Freitag“), dann neue Gerichte (in den letzten drei Wochen zum ersten Mal geplant oder schon für eine spätere Woche eingetragen) und Gerichte von der **Ideenliste**, dann Lieblingsgerichte, die lange nicht dran waren, dann weitere. Was letzte Woche auf dem Tisch stand oder schon eingeplant ist, fehlt. Ein Tipp übernimmt das Gericht samt Zutaten und springt zur nächsten offenen Mahlzeit.
- **Ideenliste:** Unten im Essens-Schritt kann man Gerichte merken, ohne sie für einen Tag einzuplanen (optional mit Zutaten). Sie gelten für die ganze Familie, passen zu jeder Mahlzeit und stehen auch im Essen-Tab zur Auswahl.
