...
<svelte:head><title>Fehler · MyFam</title></svelte:head>

<main class="mx-auto flex min-h-dvh max-w-sm flex-col justify-center px-5 py-10 text-center">
	<span
	...
	<a class="btn-primary mt-6" href="/">Zur Startseite</a>
</main>
